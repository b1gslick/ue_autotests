...
class FForDevOpsUntilLatentCommand : public IAutomationLatentCommand
{
public:
    FForDevOpsUntilLatentCommand(TFunction<void()> InCallback, TFunction<void()> InTimeoutCallback, float InTimeout = 5.0f);
